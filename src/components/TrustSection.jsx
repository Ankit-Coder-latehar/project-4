...
const TrustSection = () => {
  return (
    <div className="bg-gray-50 p-8 md:p-12 flex flex-col md:flex-row items-start space-y-8 md:space-y-0">
      {/* Left Side with Header and Image */}
      <div className="flex-1 space-y-6">
        {/* Title */}
        <h2 className="text-4xl font-bold text-gray-800">Why Trust Our Service?</h2>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 md:mt-0">
        {/* Feature 1 */}
        ...
        {/* Feature 4 */}
        <div className="flex items-start space-x-4 float-right">
